export const section = {
  ...
  content: `
        ...
        <div class="info-box info-orange" style="margin-bottom:20px">
          <strong>Инженерная сводка:</strong> Контроллеры — это мозг экрана. Ошибка в расчетах управляющей системы приведет к тому, что экран либо не включится, либо будет дико «тормозить», а вы потеряете маржу на экстренной докупке оборудования.
